...
3. 删除旧 Next.js 残留：`src/`、`node_modules/`、`.next/`、`package.json`、`bun.lock`、`tsconfig.json`、`next.config.ts`、`Dockerfile`、`docker-compose.yml`、`install.sh`、`docker-entrypoint.sh`（已被 R42-1C + R46-1A 清理）
