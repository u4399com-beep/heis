'use client'
// ============================================================
// clone-23qb FulltextView — 1:1 精仿 www.23qb.net 全本完本小说页
// 参考: 23qb.css .module.module-list.module-items / #page
// 复刻: header(简版) / main#main.wrapper > .content > .list > .box
//   ( .search-stat (标题/计数) + .module .module-list .module-items 网格 + #page 分页 )
// ============================================================
          ...
          <div className="list">
            <div className="box">
              ...
              {loading ? (
                ...
                <div style={{ padding: 40, textAlign: 'center' }}>暂无完本小说</div>
              ) : (
                        ...
                        <div key={b.id} className="module-item">
                          <div className="module-item-cover">
                            ...
                            <div className="module-item-caption">
                              <span>{b.category || '完本'} {formatWords(b.wordCount)}</span>
                            </div>
                          </div>
