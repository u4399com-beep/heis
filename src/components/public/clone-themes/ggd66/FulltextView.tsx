'use client'
// ============================================================
// clone-ggd66 FulltextView — 1:1 精仿 ggd66.com 全本小说页
...
//       / .container > .breadcrumb (首页 > 全本)
//       / .container > .content > .content-left (h2 全本完本小说 + .class 分类切换 +
//       .bookbox × N 含 .num/.bookinfo/.bookname/.author/.cat/.update) +
//       .content-right #fengyou (.search + h2 阅读排行榜 ul li) + .pages 分页 / .footer
    ...
    <>
      ...
      <div className="container">
        <ul className="breadcrumb">
          ...
          <li className="active">全本</li>
        </ul>

        <div className="content">
          <div className="content-left" id="full-list">
            <h2>全本完本小说</h2>
            ...
            <div className="class">
              <ul>
                {cats.slice(0, 9).map(c => (
                  <li key={c.id}>
                    <a href={`/quanben/sort/${c.id}/`} onClick={(e) => goCat(e, c.id)}>{c.name}</a>
                  </li>
                ))}
              </ul>
            </div>
            ...
            {loading ? (
              ...
              <div style={{ padding: 40, textAlign: 'center' }}>暂无全本小说</div>
            ) : (
              books.map((b, i) => (
