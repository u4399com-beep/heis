'use client'
// ============================================================
// clone-aijjxs FulltextView — 1:1 精仿 aijjxs.com 全本小说页
// 参考: agent-ctx/probe-html2/probe-aijjxs-category.html 的 .cenMain + .catalog listbg
// 复刻: .top-float / .wrap > .top (logo+搜索) / .layout > .cenMain
//       (.articleInfo h1 全本完本小说 + .body.filters 全本筛选
//       + .catalog listbg × N + .pager 分页) + aside (.panel.rank 热门全本下载
//       / .panel 热门作者 / .panel 相关分类)
      ...
      <div className="wrap">
        ...
        <main className="layout">
          <div className="cenMain">
            <div className="articleInfo"><h1>全本完本小说下载</h1></div>

            {/* 筛选条 (全本筛选用, 不走后端, 仅外观) */}
            <div className="body filters">
              <div className="row">
                <a href="javascript:;" className="on">最新上传</a>
                <a href="javascript:">字数最多</a>
            ...
            <div className="catalog">
              {loading ? (
                ...
                <div style={{ padding: 40, textAlign: 'center', color: '#6b7280' }}>暂无全本小说</div>
