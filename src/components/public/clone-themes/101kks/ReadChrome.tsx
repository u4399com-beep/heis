...
const C = {"id":"101kks","bg":"#f2f3f4","surface":"#fff","text":"#333","muted":"#666","primary":"#667eea","accent":"#764ba2","border":"#eee","radius":"10px","font":"\"Microsoft YaHei\",sans-serif","maxW":1200}
