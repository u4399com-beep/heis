...
// R7-10 人类化鼠标移动 (humanMoveAndClick) + R7-11 隐身有效性自检 (validateStealth)
// 已移除 —— 全域无消费者(仅脚本 archive/ 旧探针曾用过, 已废弃)。obscura 入口仅
// obscuraFetch + withObscuraPage + renderStealth 三组对外 API。
