// ============================================================
// 主题模版注册表 — 10 套精仿真实小说站点主题 (R11-1B 新增 clone-trxsw)
// 10 套 preset 全部基于真实站点首页 HTML+CSS 抓取/GitHub 书源规则反推, 像素级精仿:
...
//   clone-trxsw      (天人小说 trxsw.com, GitHub mason173/aira-browser 反查 .vlist/.detail/.content DOM)
//
// 双布局维度:
...
// R11-1B: 新增第 10 套 clone-trxsw (天人小说, AiraBrowser 反查 DOM, 域名已过期但规则保留)
// ============================================================
