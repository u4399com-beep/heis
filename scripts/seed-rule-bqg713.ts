  ...
  config: {
    list: {
      ...
      fields: {
        ...
        // 封面图: list API JSON 无 cover, 站点 SPA 用 /bookimg/{floor:id/1000}/{id}.jpg 分子目录
        // (agent-browser 实测 bqg616.cc/#/book/5098/ img.src=/bookimg/5/5098.jpg, 5=floor(5098/1000);
        //  parser constTemplate 支持 {floor:field/divisor} 语法 R7-31; {id}=list段fields.id值)
        cover: { type: 'const', expression: 'https://www.bqg713.cc/bookimg/{floor:id/1000}/{id}.jpg' },
    ...
    book: {
      ...
      fields: {
        ...
        intro: { type: 'json', expression: 'intro' },
        // 封面图: API JSON 无 cover, 站点 SPA 用 /bookimg/{floor:q.id/1000}/{q.id}.jpg 分子目录
        // (agent-browser 实测 book/5098 → /bookimg/5/5098.jpg, 5=floor(5098/1000);
        //  parser constTemplate 支持 {floor:field/divisor} 语法 R7-31; {q.id}=书籍页URL查询参数id)
        cover: { type: 'const', expression: 'https://www.bqg713.cc/bookimg/{floor:q.id/1000}/{q.id}.jpg' },
